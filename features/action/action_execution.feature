...
Feature: Actions Execution
  ...
  Scenario: Have a document with an action that doesn't implement the required action method
    ...
    Then I should see a "UnimplementedParserInputDocument" in "failures" with the following
      ...
      | published_metadata | {}                                                                                                                                                                               |
      | pending_actions    | []                                                                                                                                                                               |
      | failed_actions     | {'unimplemented_parser' => {'class' => 'Armagh::Actions::Errors::ActionMethodNotImplemented', 'message' => 'ParseActions must overwrite the parse method.', 'trace' => 'anything'}} |
      | draft_content      | {'text' => 'incoming content'}                                                                                                                                                   |
      | published_content  | {}                                                                                                                                                                               |
      | state              | 'ready'                                                                                                                                                                          |
      | locked             | false                                                                                                                                                                            |
  ...
  Scenario: Have a collector that produces duplicate documents
    ...
    Then I should see a "DuplicateInputDocType" in "failures" with the following
      ...
      | published_metadata | {}                                                                                                                                                                                                                  |
      | pending_actions    | []                                                                                                                                                                                                                  |
      | failed_actions     | {'duplicate_collector' => {'class' => 'Armagh::Documents::Errors::DocumentUniquenessError', 'message' => 'Unable to create document 123.  This document already exists.', 'trace' => 'anything', 'cause' => 'anything'}} |
      | draft_content      | {'text' => 'incoming content'}                                                                                                                                                                                      |
      | published_content  | {}                                                                                                                                                                                                                  |
      | state              | 'ready'                                                                                                                                                                                                             |
      | locked             | false                                                                                                                                                                                                               |
  ...
  Scenario: Have a collector that produces documents that are too large
    ...
    Then I should see a "TooLargeInputDocType" in "failures" with the following
      ...
      | draft_metadata    | {'meta' => 'incoming meta'}                                                                                                                                                                                                            |
      | pending_actions   | []                                                                                                                                                                                                                                     |
      | failed_actions    | {'too_large_collector' => {'class' => 'Armagh::Documents::Errors::DocumentSizeError', 'message' => 'Document 123 is too large.  Consider using a splitter or parser to split the document.', 'trace' => 'anything', 'cause' => 'anything'}} |
      | draft_content     | {'text' => 'incoming content'}                                                                                                                                                                                                         |
      | published_content | {}                                                                                                                                                                                                                                     |
      | state             | 'ready'                                                                                                                                                                                                                                |
      | locked            | false                                                                                                                                                                                                                                  |
  ...
  Scenario: Have a parser that edits documents that are too large
    ...
    Then I should see a "TooLargeInputDocType" in "failures" with the following
      ...
      | draft_metadata    | {'meta' => 'incoming meta'}                                                                                                                                                                                                               |
      | pending_actions   | []                                                                                                                                                                                                                                        |
      | failed_actions    | {'too_large_parser' => {'class' => 'Armagh::Documents::Errors::DocumentSizeError', 'message' => 'Document parse_123 is too large.  Consider using a splitter or parser to split the document.', 'trace' => 'anything', 'cause' => 'anything'}} |
      | draft_content     | {'text' => 'incoming content'}                                                                                                                                                                                                            |
      | published_content | {}                                                                                                                                                                                                                                        |
      | state             | 'ready'                                                                                                                                                                                                                                   |
      | locked            | false                                                                                                                                                                                                                                     |
  ...
  Scenario: Have a parser that edits the current document
    ...
    Then I should see a "EditCurrentInputDocType" in "failures" with the following
      ...
      | published_metadata | {}                                                                                                                                                                                                                |
      | pending_actions    | []                                                                                                                                                                                                                |
      | failed_actions     | {'edit_current_parser' => {'class' => 'Armagh::Documents::Errors::DocumentError', 'message' => 'Cannot edit document \'incoming\'.  It is the same document that was passed into the action.', 'trace' => 'anything'}} |
      | draft_content      | {'text' => 'incoming content'}                                                                                                                                                                                    |
      | published_content  | {}                                                                                                                                                                                                                |
      | state              | 'ready'                                                                                                                                                                                                           |
      | locked             | false                                                                                                                                                                                                             |
